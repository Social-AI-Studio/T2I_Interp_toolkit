...
def test_t2i_hooks():
    ...
    accessor = ModuleAccessor(
        model.pipeline.unet.mid_block.resnets[0], "mid_block_0", IOType.OUTPUT
    )
...
def test_interventions():
    ...
    intervention = AddVectorIntervention(
        accessors=[accessor], steering_vec=steering_vec, start_step=0, end_step=5
    )
