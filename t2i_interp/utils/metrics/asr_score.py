...
def main():
    ...
    ap.add_argument(
        "--jsonl", type=str, required=True, help="JSONL with {'prompt','response'} per line"
    )
    ap.add_argument(
        "--judge", type=str, default="none", choices=["none", "rule", "openai_moderation"]
    )
    ...
    ap.add_argument(
        ...
        type=str,
        nargs="*",
        default=["here is how", "step-by-step"],
